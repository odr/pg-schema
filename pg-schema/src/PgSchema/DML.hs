...
-- (never inserts). Unlike 'upsertJSON', flat upsert does not accept mandatory OR
-- key. See their Haddock for @Maybe@ returning rules. Plain 'insertSch' /
-- 'insertSch_' require all mandatory fields for flat rows.
--
