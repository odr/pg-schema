...
type GetTypDef sch tab fld = TTypDef sch (FdType (TFldDef sch tab fld))
...
-- Use 'TFieldInfo' to get 'RecFieldK' directly instead of composing CFldDef/CTabRels/getRecField.
-- Extension: Empty and Aggr depend on the record field type; use overlappable default for unknown names.
